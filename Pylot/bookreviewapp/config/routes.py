...
"""
routes['default_controller'] = 'Users' #done need TEST
routes['POST']['/signin/check'] = 'Users#signincheck' #done need TEST
routes['POST']['/register/check'] ='Users#registercheck' #done need TEST
routes['/books'] = 'Users#books' #done need TEST
routes['/books/<id>'] = 'Users#bookhomepage'
routes['POST']['/addreview/<bookid>/<userid>'] = 'Users#book_review'
routes['/delete/<reviewid>/<bookid>'] ='Users#delete_review'
routes['/users/<id>'] = "Users#userhomepage"
routes['/books/add'] ="Users#addbook"
routes['POST']['/addbookreview'] = "Users#addbookreview"
